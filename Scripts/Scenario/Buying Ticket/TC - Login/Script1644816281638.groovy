...
WebUI.callTestCase(findTestCase('Scenario/Buying Ticket/TC - Search Flight'), [('Type') : Type, ('From') : From, ('To') : To
        , ('DateDepart') : DateDepart, ('DateReturn') : DateReturn, ('Classes') : Classes, ('Adults') : Adults, ('Childs') : Childs
